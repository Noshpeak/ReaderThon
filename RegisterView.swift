...
struct RegisterView: View{
    ...
    var body: some View{
        VStack(spacing: 10){
            ...
            Text("Hello Parents, Thanks for register ")
                .font(.title3)
                .hAlign(.leading)
    ...
    func HelperView()->some View{
        VStack(spacing: 12){
            ...
            .disableWithOpacity(userRole == "" || emailID == "" || password == "" || userProfilePicData == nil)
            .padding(.top,10)
        }
    }
    ...
    func registerUser(){
        ...
        Task{
            do{
                ...
                let user = User(userRole: userRole, userUID: userUID, userEmail: emailID, userProfileURL: downloadURL)
